...
class BoxesGame(ConnectionListener):
    def initSound(self):
        ...
        self.winSound = pygame.mixer.Sound('resources/audio/win.wav')
        self.loseSound = pygame.mixer.Sound('resources/audio/lose.wav')
        self.placeSound = pygame.mixer.Sound('resources/audio/place.wav')
    ...
    def __init__(self):
        ...
        #7
        address=raw_input("Input Address of Server(localhost:8000): ")
        try:
            if not address:
        ...
        #8 Wait until get the startgame signal
        self.running = False
