...
def speedx(snd_array, factor):
    """ Speeds up / Slow down a sound, by some factor
    :param snd_array: Sound Array
    :param factor: factor to speed up or slow down
    :return: new sound array after speed_up / slow_down
    """
...
def stretch(snd_array, factor, window_size, h):
    """ Stretches / shorten a sound, by some factor
    :param snd_array:
    :param factor:
    :param window_size:
    :param h:
